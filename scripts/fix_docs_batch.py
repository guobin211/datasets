...
DOCS = "/Users/guobin/tencent/datasets/docs/"

def load(name):
    with io.open(DOCS + name, "r", encoding="utf-8") as f:
        return f.read()

def save(name, text):
    with io.open(DOCS + name, "w", encoding="utf-8") as f:
        f.write(text)
...
# ================= 22 · CLI 交互流 =================
rep("22-open-context-cli-flow.md",
...
# ================= 23 · HTTP/WS 流程 =================
rep("23-open-context-http-ws-flow.md",
...
# ================= 20 · 架构导读 =================
rep("20-open-context-architecture.md",
...
# ================= 11 · 依赖清单 =================
rep("11-dependency-inventory.md",
